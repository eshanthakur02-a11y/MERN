...
export default function SignupPage() {
  ...
  const handleSignup = async (e) => {
    ...
    localStorage.setItem("ai_user", JSON.stringify({ email, name }));
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-card">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Start creating AI-powered content</p>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              ...
              <Input id="name" required value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name" className="mt-1" />
            </div>
            <div>
